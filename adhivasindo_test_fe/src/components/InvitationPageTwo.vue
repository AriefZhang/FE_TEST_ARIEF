<template>
  <div class="page_two_wrapper h-100 overflow-hidden">
    <img
      class="page_two_background position-absolute w-100"
      src="@/assets/ASSET_PNG/BG_Page_2.jpg"
      alt=""
      ref="bgImg"
    />
    <img
...
.page_two_pic_profile_inner_wrapper {
  border-radius: calc(100vw * 0.5);
